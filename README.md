...
**For Windows 11 users**: Pre-built installers and portable executables are automatically generated for every commit and available in the [GitHub Actions artifacts](https://github.com/goodthebest/tdesktopx/actions/workflows/win.yml).
...
4. Download the appropriate artifact:
   - **Telegram_x64**: Windows 11 64-bit installer and executables
   - **Telegram_Win32**: Windows 11 32-bit installer and executables

The artifacts include:
- **MyTelegram-Setup-[version].exe**: Full installer for Windows 11
